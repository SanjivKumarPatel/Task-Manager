...
function Home() {
  const features = [
    ...
    {
      title: 'Notifications',
      description: 'Stay updated with important activity and task reminders.',
      icon: Bell
    }
  ]
        ...
        <div className='max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center'>
          ...
          <div>
            ...
            <p className='mt-6 max-w-2xl text-lg leading-8 text-slate-600'>
              TaskNova helps teams manage tasks, collaborate efficiently, and
              stay productive with a modern workflow.
            </p>
            ...
            <div className='mt-8 space-y-5'>
              {features.map((feature) => {
                ...
                return (
                  <div
                    key={feature.title}
                    className='flex items-start gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-5 transition hover:bg-blue-50'
                  >
